...
class Trainer:
    ...
    def train(self):
        ...
        best_f1 = 0.0
        checkpoint_dir = self.project_root / "checkpoints" / f"{self.cfg.model.base_model}_{datetime.now().strftime('%d-%m')}"
        ...
        for epoch in range(self.cfg.training.epochs):
            ...
            if val_f1 > best_f1:
                best_f1 = val_f1
                checkpoint_path = checkpoint_dir / f"{self.cfg.model.base_model}_F1_{val_f1:.2f}.pth"
